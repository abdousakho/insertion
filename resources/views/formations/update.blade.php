        ...
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form method="POST" action="{{ action('GestionnairesController@update', $id) }}">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><b>Intitulé</b></label>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1"><b>niveaus:</b></label>
